...
let sectorButtonClick = function (evt) {
    let filterFunction = function (d) {
        return d.general.Sector === evt.target.innerText;
    }
    displayOverview(filterFunction);
}
...
let displayOverview = function (filterFunction) {
    ...
    d3.json(data_addr, function (error, data) {        
        ...
        let mouseclick = function (d) {
            console.log(d.general["Ticker Symbol"]);
            d3.select(this)
